...
(function (S, undefined) {
  ...
  function mixInternal(r, s, ov, wl, deep, cache) {
    ...
    // è®°å½•è¢«è®°å½•äº†å¾ªçŽ¯æ ‡å¿—çš„å¯¹åƒ
    cache.push(s);
  ...
  function _mix(p, r, s, ov, wl, deep, cache) {
    ...
    if (ov || !(p in r) || deep) {
      ...
      // æ¥æºæ˜¯æ•°ç»„å’Œå¯¹è±¡ï¼Œå¹¶ä¸”è¦æ±‚æ·±åº¦ mix
      if (deep && src && (S.isArray(src) || S.isPlainObject(src))) {
        if (src[MIX_CIRCULAR_DETECTION]) {
          r[p] = src[MIX_CIRCULAR_DETECTION];
        } else {
          // ç›®æ ‡å€¼ä¸ºå¯¹è±¡æˆ–æ•°ç»„ï¼Œç›´æŽ¥ mix
          // å¦åˆ™ æ–°å»ºä¸€ä¸ªå’Œæºå€¼ç±»åž‹ä¸€æ ·çš„ç©ºæ•°ç»„/å¯¹è±¡ï¼Œé€’å½’ mix
          var clone =
            target && (S.isArray(target) || S.isPlainObject(target))
              ? target
              : S.isArray(src)
              ? []
              : {};
...
(function (S, undefined) {
  ...
  S.mix(S, {
    ...
    equals: function (
      a,
      b,
      /*internal use*/ mismatchKeys,
      /*internal use*/ mismatchValues
    ) {
      // inspired by jasmine
  ...
  function cloneInternal(input, f, memory) {
    ...
    if (input[CLONE_MARKER]) {
      ...
      // å­˜å‚¨æºå¯¹è±¡ä»¥åŠå…‹éš†åŽçš„å¯¹è±¡
  ...
  function compareObjects(a, b, mismatchKeys, mismatchValues) {
    // ä¸¤ä¸ªæ¯”è¾ƒè¿‡äº†ï¼Œæ— éœ€å†æ¯”è¾ƒï¼Œé˜²æ­¢å¾ªçŽ¯æ¯”è¾ƒ
      ...
      if (!S.equals(a[property], b[property], mismatchKeys, mismatchValues)) {
        mismatchValues.push(
          '"' +
            ...
            '" in expected, but was "' +
            (a[property] ? a[property].toString() : a[property]) +
            '" in actual.'
        );
      }
    }
...
(function (S, undefined) {
  ...
  S.each(
    "Boolean Number String Function Date RegExp Object Array".split(" "),
    function (name, lc) {
...
(function (S) {
  ...
  var Path = (S.Path = {
    ...
    resolve: function () {
      ...
      resolvedPathStr = normalizeArray(
        S.filter(resolvedPath.split("/"), function (p) {
          return !!p;
        }),
        !absolute
      ).join("/");
    ...
    normalize: function (path) {
      ...
      path = normalizeArray(
        S.filter(path.split("/"), function (p) {
          return !!p;
        }),
        !absolute
      ).join("/");
...
(function (S, undefined) {
  ...
  Uri.prototype = {
    ...
    isSameOriginAs: function (other) {
      ...
      return (
        equalsIgnoreCase(self.hostname, other.hostname) &&
    ...
    toString: function (serializeArray) {
      ...
      if ((hostname = self.hostname)) {
        ...
        if ((userInfo = self.userInfo)) {
          out.push(
            encodeSpecialChars(userInfo, reDisallowedInSchemeOrUserInfo)
          );
          out.push("@");
        }
...
(function (S, undefined) {
  ...
  function getDescriptorFromUserAgent(ua) {
    var EMPTY = "",
      ...
      IE_DETECT_TPL =
        "<!--[if IE " + VERSION_PLACEHOLDER + "]><" + "s></s><![endif]-->",
    ...
    if (s.length > 0) {
      ...
      // æ³¨æ„ï¼š
      //  UA.shell = ie, è¡¨ç¤ºå¤–å£³æ˜¯ ie
      //  ä½† UA.ie = 7, å¹¶ä¸ä»£è¡¨å¤–å£³æ˜¯ ie7, è¿˜æœ‰å¯èƒ½æ˜¯ ie8 çš„å…¼å®¹æ¨¡å¼
      //  å¯¹äºŽ ie8 çš„å…¼å®¹æ¨¡å¼ï¼Œè¿˜è¦é€šè¿‡ documentMode åŽ»åˆ¤æ–­ã€‚ä½†æ­¤å¤„ä¸èƒ½è®© UA.ie = 8, å¦åˆ™
      //  å¾ˆå¤šè„šæœ¬åˆ¤æ–­ä¼šå¤±è¯¯ã€‚å› ä¸º ie8 çš„å…¼å®¹æ¨¡å¼è¡¨çŽ°è¡Œä¸ºå’Œ ie7 ç›¸åŒï¼Œè€Œä¸æ˜¯å’Œ ie8 ç›¸åŒ
      ...
      // NOT WebKit
        ...
        if ((m = ua.match(/Presto\/([\d.]*)/)) && m[1]) {
          ...
          if ((m = ua.match(/Opera\/([\d.]*)/)) && m[1]) {
            ...
            // issue: ç”±äºŽ Opera Mobile æœ‰ Version/ å­—æ®µï¼Œå¯èƒ½ä¼šä¸Ž Opera æ··æ·†ï¼ŒåŒæ—¶å¯¹äºŽ Opera Mobile çš„ç‰ˆæœ¬å·ä¹Ÿæ¯”è¾ƒæ··ä¹±
          ...
          // MSIE
          // ç”±äºŽæœ€å¼€å§‹å·²ç»ä½¿ç”¨äº† IE æ¡ä»¶æ³¨é‡Šåˆ¤æ–­ï¼Œå› æ­¤è½åˆ°è¿™é‡Œçš„å”¯ä¸€å¯èƒ½æ€§åªæœ‰ IE10+
...
/*
 ...
 - ie < 10 ä½¿ç”¨æ¡ä»¶æ³¨é‡Šåˆ¤æ–­å†…æ ¸ï¼Œæ›´ç²¾ç¡®

 2010.03
 - jQuery, YUI ç­‰ç±»åº“éƒ½æŽ¨èç”¨ç‰¹æ€§æŽ¢æµ‹æ›¿ä»£æµè§ˆå™¨å—…æŽ¢ã€‚ç‰¹æ€§æŽ¢æµ‹çš„å¥½å¤„æ˜¯èƒ½è‡ªåŠ¨é€‚åº”æœªæ¥è®¾å¤‡å’ŒæœªçŸ¥è®¾å¤‡ï¼Œæ¯”å¦‚
 if(document.addEventListener) å‡è®¾ IE9 æ”¯æŒæ ‡å‡†äº‹ä»¶ï¼Œåˆ™ä»£ç ä¸ç”¨ä¿®æ”¹ï¼Œå°±è‡ªé€‚åº”äº†â€œæœªæ¥æµè§ˆå™¨â€ã€‚
 å¯¹äºŽæœªçŸ¥æµè§ˆå™¨ä¹Ÿæ˜¯å¦‚æ­¤ã€‚ä½†æ˜¯ï¼Œè¿™å¹¶ä¸æ„å‘³ç€æµè§ˆå™¨å—…æŽ¢å°±å¾—å½»åº•æŠ›å¼ƒã€‚å½“ä»£ç å¾ˆæ˜Žç¡®å°±æ˜¯é’ˆå¯¹å·²çŸ¥ç‰¹å®šæµè§ˆå™¨çš„ï¼Œ
 åŒæ—¶å¹¶éžæ˜¯æŸä¸ªç‰¹æ€§æŽ¢æµ‹å¯ä»¥è§£å†³æ—¶ï¼Œç”¨æµè§ˆå™¨å—…æŽ¢åè€Œèƒ½å¸¦æ¥ä»£ç çš„ç®€æ´ï¼ŒåŒæ—¶ä¹Ÿä¹Ÿä¸ä¼šæœ‰ä»€ä¹ˆåŽæ‚£ã€‚æ€»ä¹‹ï¼Œä¸€åˆ‡
 çš†æƒè¡¡ã€‚
...
(function (S, undefined) {
  ...
  if (documentElement) {
    ...
    S.each(VENDORS, function (val) {
      ...
      if (transformPrefix === undefined && transform in documentElementStyle) {
        transformPrefix = val;
    ...
    if (transformProperty) {
      ...
      try {
        ...
        var has3d =
          computedStyle.getPropertyValue(transformProperty) ||
          computedStyle[transformProperty];
  ...
  S.Features = {
    ...
    isTouchGestureSupported: function () {
      return (
        isTouchEventSupportedState || isPointerSupported || isMsPointerSupported
      );
    },
    ...
    isHashChangeSupported: function () {
      // ie8 æ”¯æŒ hashchange
      // ä½† ie8 ä»¥ä¸Šåˆ‡æ¢æµè§ˆå™¨æ¨¡å¼åˆ° ie7ï¼ˆå…¼å®¹æ¨¡å¼ï¼‰ï¼Œ
      // ä¼šå¯¼è‡´ 'onhashchange' in window === trueï¼Œä½†æ˜¯ä¸è§¦å‘äº‹ä»¶
...
(function (S) {
  ...
  // å¦‚æžœæ¨¡å—åä»¥ / ç»“å°¾ï¼Œè‡ªåŠ¨åŠ  index
  ...
  S.mix(Utils, {
    ...
    createModuleInfo: function (runtime, modName, cfg) {
      ...
      // é˜²æ­¢ cfg é‡Œæœ‰ tagï¼Œæž„å»º fullpath éœ€è¦
      mods[modName] = module = new Loader.Module(
        S.mix(
          {
            name: modName,
            runtime: runtime,
    ...
    checkModsLoadRecursively: function (
      modNames,
      runtime,
      stack,
      errorList,
    ...
    checkModLoadRecursively: function (
      modName,
      runtime,
      stack,
      errorList,
      ...
      if (
        Utils.checkModsLoadRecursively(
          m.getNormalizedRequires(),
          runtime,
          stack,
          errorList,
          cache
    ...
    attachMod: function (runtime, module) {
      ...
      if (typeof factory === "function") {
        ...
        // éœ€è¦è§£å¼€ indexï¼Œç›¸å¯¹è·¯å¾„
        // ä½†æ˜¯éœ€è¦ä¿ç•™ aliasï¼Œé˜²æ­¢å€¼ä¸å¯¹åº”
        //noinspection JSUnresolvedFunction
        exports = factory.apply(
          module,
          // KISSY.add(function(S){module.require}) lazy initialize
          module.cjs
            ? [runtime, require, module.exports, module]
    ...
    registerModule: function (runtime, name, factory, config) {
      ...
      // æ²¡æœ‰ useï¼Œé™æ€è½½å…¥çš„ add å¯èƒ½æ‰§è¡Œ
      Utils.createModuleInfo(runtime, name);

      module = mods[name];

      // æ³¨æ„ï¼šé€šè¿‡ S.add(name[, factory[, config]]) æ³¨å†Œçš„ä»£ç ï¼Œæ— è®ºæ˜¯é¡µé¢ä¸­çš„ä»£ç ï¼Œ
      // è¿˜æ˜¯ js æ–‡ä»¶é‡Œçš„ä»£ç ï¼Œadd æ‰§è¡Œæ—¶ï¼Œéƒ½æ„å‘³ç€è¯¥æ¨¡å—å·²ç» LOADED
      S.mix(module, {
        name: name,
        status: LOADED,
        factory: factory,
  ...
  Module.prototype = {
    ...
    getFullPathUri: function () {
      ...
      if (!self.fullPathUri) {
        ...
        if (self.fullpath) {
          ...
          // #262
          if (
            packageInfo.isIgnorePackageNameInUri() &&
    ...
    getNormalizedRequires: function () {
      ...
      if (!requires || requires.length === 0) {
        ...
        (normalizedRequires = self.normalizedRequires) &&
        // äº‹å…ˆå£°æ˜Žçš„ä¾èµ–ä¸èƒ½å½“åš loaded çŠ¶æ€ä¸‹çœŸæ­£çš„ä¾èµ–
        normalizedRequiresStatus === status
      ) {
        return normalizedRequires;
      } else {
        self.normalizedRequiresStatus = status;
        self.normalizedRequires = Utils.normalizeModNames(
          self.runtime,
          requires,
          self.name
        );
...
(function (S) {
  ...
  function isCssLoaded(node, url) {
    ...
    if (UA.webkit) {
      ...
      try {
        ...
        var exName = ex.name;
        logger.debug(
          "css poll exception: " + exName + " " + ex.code + " " + url
        );
  ...
  // æš‚æ—¶ä¸è€ƒè™‘å¦‚ä½•åˆ¤æ–­å¤±è´¥ï¼Œå¦‚ 404 ç­‰
...
/*
 ...
 - firefox not okï¼ˆ4 is wrongï¼‰ï¼š
...
(function (S) {
  ...
  S.getScript = function (url, success, charset) {
    ...
    //æ ‡å‡†æµè§ˆå™¨ css and all script
    if (useNative) {
      node.onload = onload;
...
/*
 ...
 - è€ƒè™‘è¿žç»­é‡å¤è¯·æ±‚å•ä¸ª script çš„æƒ…å†µï¼Œå†…éƒ¨æŽ’é˜Ÿ
...
(function (S, undefined) {
      ...
      var config = {
        ...
        success: function () {
          ...
          if (mod && currentMod) {
            ...
            logger.debug(
              "standard browser get mod name after load : " + mod.name
            );
  ...
  ComboLoader.add = function (name, factory, config, runtime, argsLen) {
    ...
    if (typeof name === "function" || argsLen === 1) {
      ...
      if (oldIE) {
        ...
        // å…¶ä»–æµè§ˆå™¨ onload æ—¶ï¼Œå…³è”æ¨¡å—åä¸Žæ¨¡å—å®šä¹‰
        currentMod = {
          factory: factory,
          config: config,
        };
  ...
  // oldIE ç‰¹æœ‰ï¼Œæ‰¾åˆ°å½“å‰æ­£åœ¨äº¤äº’çš„è„šæœ¬ï¼Œæ ¹æ®è„šæœ¬åç¡®å®šæ¨¡å—å
  // å¦‚æžœæ‰¾ä¸åˆ°ï¼Œè¿”å›žå‘é€å‰é‚£ä¸ªè„šæœ¬
  function findModuleNameByInteractive() {
    ...
    if (re) {
      ...
      logger.debug(
        "can not find interactive script,time diff : " +
          (S.now() - startLoadModTime)
      );
  ...
  S.augment(ComboLoader, {
    ...
    calculate: function (modNames, cache, ret) {
      ...
      ret = ret || {};
      // æé«˜æ€§èƒ½ï¼Œä¸ç”¨æ¯ä¸ªæ¨¡å—éƒ½å†æ¬¡å…¨éƒ¨ä¾èµ–è®¡ç®—
      // åšä¸ªç¼“å­˜ï¼Œæ¯ä¸ªæ¨¡å—å¯¹åº”çš„å¾…åŠ¨æ€åŠ è½½æ¨¡å—
      cache = cache || {};
    ...
    getComboMods: function (modNames, comboPrefixes) {
      ...
      for (; i < l; ++i) {
        ...
        if (
          (mod.canBeCombined =
            packageInfo.isCombine() && S.startsWith(fullpath, packagePath)) &&
          group
        ) {
      ...
      for (var type in comboMods) {
        ...
        for (var comboName in comboMods[type]) {
          ...
          for (var i = 0; i < mods.length; i++) {
            ...
            if (
              currentComboUrls.length > maxFileNum ||
              l + currentComboUrls.join(comboSep).length + suffixLength >
                maxUrlLength
            ) {
...
(function (S, undefined) {
  ...
  S.mix(S, {
    ...
    use: function (modNames, success) {
      ...
      function loadReady() {
        ...
        var errorList = [],
          start = S.now(),
          ret;
        ret = Utils.checkModsLoadRecursively(
          normalizedModNames,
          S,
          undefined,
          errorList
    ...
    require: function (moduleName, refName) {
      if (moduleName) {
        var moduleNames = Utils.unalias(
          S,
          Utils.normalizeModNamesWithAlias(S, [moduleName], refName)
        );
...
(function (S, undefined) {
  ...
  var win = S.Env.host,
    ...
    LOAD_EVENT = "load",
    COMPLETE = "complete",
    addEventListener = standardEventModel
      ? function (el, type, fn) {
    ...
    removeEventListener = standardEventModel
      ? function (el, type, fn) {
...
(function (S) {
  ...
  if (typeof location !== "undefined") {
    ...
    var prefix = https
      ? "https://s.tbcdn.cn/s/kissy/"
      : "http://a.tbcdn.cn/s/kissy/";
    S.config({
      packages: {
        gallery: {
          base: prefix,
...
(function (config, Features, UA) {
  ...
  config({
    "event/dom": {
      alias: [
        "event/dom/base",
        Features.isTouchGestureSupported() ? "event/dom/touch" : "",
  ...
  config({
    "scroll-view": {
      alias: Features.isTouchGestureSupported()
        ? "scroll-view/drag"
        : "scroll-view/base",
    },
  }); /*Generated By KISSY Module Compiler*/
    ...
    S.parseJson = function (data) {
      ...
      if (typeof data === "string") {
        ...
        if (data) {
          // from json2
          if (
            INVALID_CHARS_REG.test(
              data
                .replace(INVALID_ESCAPES_REG, "@")
